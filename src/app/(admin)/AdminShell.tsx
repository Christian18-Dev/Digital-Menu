      ...
      <div className="min-h-screen bg-slate-50 text-slate-900">
        <div className="flex min-h-screen w-full">
          <aside className="hidden w-80 shrink-0 border-r border-slate-200 bg-white px-6 py-8 md:block">
            <div className="card w-72 rounded-md bg-white p-5 shadow-md shadow-purple-200/50">
              <div className="px-1">
          ...
          {isMobileNavOpen && (
            <div className="fixed inset-0 z-40 md:hidden">
              ...
              <aside className="absolute left-0 top-0 h-full w-80 border-r border-slate-200 bg-white px-6 py-8 shadow-lg">
                ...
                <div className="mt-6 card w-72 rounded-md bg-white p-5 shadow-md shadow-purple-200/50">
                  <div className="px-1">
                  </div>
